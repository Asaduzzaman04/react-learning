...
const Cards = ({value}) => {
	...
	const {image,title,rating, price} = value //destructur the props value
...
<div className="">
	<div className="bg-white shadow-md rounded-t-xl   rounded-b-xl max-w-sm dark:bg-gray-800 dark:border-gray-700">
		<a href="/">
			<img className="rounded-t-xl border w-full aspect-square " src={image} alt={title} />
        </a>
			<div className="px-5 pb-5 mt-5">
				...
				<div className="flex items-center justify-between">
					<span className="text-3xl font-bold text-gray-900 dark:text-white">${Math.round(price)}</span>
					<a href="/"
